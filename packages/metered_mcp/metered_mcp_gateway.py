...
SERVER_METADATA = {
    ...
    "version": "5.4.3",
    "description": "Sub-35µs in-process AI agent security gate. Evaluates every tool call before execution — blocks rm -rf, DROP TABLE, and secret exfiltration before the syscall is made. Pay $0.005 per check or subscribe for flat-rate ($49/mo Pro, $199/mo Enterprise).",
