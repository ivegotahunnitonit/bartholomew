...
import json
import pytest
from scripts.independent_verifier_standalone import StandaloneBTPVerifier, run_standalone_verification_suite
...
def test_btp_test_vectors_standalone_compliance():
    ...
    """
    vec_path = os.path.join(os.path.dirname(__file__), "fixtures", "btp_test_vectors.json")
    assert run_standalone_verification_suite(vec_path) is True
