...
def get_btp_well_known():
    ...
    return {
        ...
        "endpoints": {
            ...
            "offline_verifier": "https://raw.githubusercontent.com/bartholomew-ai/bartholomew/main/standalone_btp_verifier.py"
        },
...
- **Go**: go get github.com/bartholomew-ai/bartholomew/pkg/btp
