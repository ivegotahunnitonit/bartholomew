...
### References
- Spec: https://github.com/bartholomew-ai/bartholomew/blob/main/BTP_PROTOCOL_SPECIFICATION.md
- Standalone Verifier: https://github.com/bartholomew-ai/bartholomew/blob/main/standalone_btp_verifier.py
"""
        },
        {
...
### References
- Challenge & Invariants: https://github.com/bartholomew-ai/bartholomew/blob/main/CHALLENGE_PACKAGE.md
"""
        },
        {
