...
* **Production Kubernetes & Helm Chart**: Enterprise private VPC Helm deployment with dedicated sidecar container (`ghcr.io/ivegotahunnitonit/bartholomew-sidecar:5.4.4`).
