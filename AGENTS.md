# AGENTS.md — Bartholomew BTP v5.4.14
...
```json
{
  ...
  "identity": { "name": "Bartholomew Trust Protocol", "protocol_version": "5.4.14" },
...
| **OpenAI Agents SDK** | `examples/gpt_astra_agents_sdk.md` | `pip install btp-guard openai` |
