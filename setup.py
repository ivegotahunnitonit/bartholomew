...
setup(
    name="btp-guard",
    version="5.4.8",
    description="Bartholomew Protocol (BTP v5.4.8) -- Sovereign Sentinel Companion & Autonomous AI Agent Execution Gateway. Sub-35us AST safety gating, bilateral BMU barter economy, in-flight secret scrubbing, and multi-model defense for GPT-Astra, Claude 3.7, Gemini 2.0, DeepSeek-R1, CrewAI, LangGraph, AutoGen, and LlamaIndex.",
