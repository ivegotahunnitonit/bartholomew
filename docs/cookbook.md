...
| **Being Built** | OpenAI Function Calling (GPT-4o) | Function Dispatcher Guard | [`cookbook/already_built/openai_tool_calling_guard.py`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/cookbook/already_built/openai_tool_calling_guard.py) |
| **Being Built** | Anthropic Claude & Computer Use | Tool Use / Bash Sandbox Block | [`cookbook/already_built/anthropic_computer_use_guard.py`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/cookbook/already_built/anthropic_computer_use_guard.py) |
| **Being Built** | Google Gemini 1.5 / 2.0 | Function Calling Attestation | [`cookbook/already_built/gemini_function_calling_guard.py`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/cookbook/already_built/gemini_function_calling_guard.py) |
| **Being Built** | Node.js / TypeScript | `btp-guard` npm Module | [`cookbook/already_built/typescript_node_agent.ts`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/cookbook/already_built/typescript_node_agent.ts) |
...
| **Frontier AI** | Google Gemini 3.8 Ultra | Thought Scratchpad & Tool Budget Gate | [`examples/being_built/google_gemini38_guard.py`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/examples/being_built/google_gemini38_guard.py) |
| **Frontier AI** | Anthropic Claude 3.7 Sonnet | Hybrid Thinking & Bash Sandbox Gate | [`examples/being_built/anthropic_claude37_guard.py`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/examples/being_built/anthropic_claude37_guard.py) |
| **Frontier AI** | GPT-Astra / OpenAI Agents SDK | Function Dispatcher & Schema Guard | [`examples/being_built/openai_agents_sdk_guard.py`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/examples/being_built/openai_agents_sdk_guard.py) |
| **Edge AI** | Cloudflare Workers AI & Agents | Sub-50µs Edge AST Gate & KV Replay Defense | [`examples/future_swarms/cloudflare_edge_agent_guard.ts`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/examples/future_swarms/cloudflare_edge_agent_guard.ts) |
| **Swarm AI** | Microsoft AutoGen GroupChats | `@btp_autogen_guard` + Quorum Consensus + AWU Barter | [`examples/future_swarms/autogen_swarm_consensus.py`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/examples/future_swarms/autogen_swarm_consensus.py) |
| **IDE AI** | GitHub Copilot / Cursor / Windsurf | In-Process MCP Gateway & `.cursorrules` Sentry | [`examples/ides/`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/examples/ides/) & [`mcp_server.py`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/mcp_server.py) |
| **Universal Swarm**| Universal A2A Multi-Agent Mesh | Ed25519 Envelopes, Nonces & L402 Micropayments | [`examples/future_swarms/universal_swarm_delegation.py`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/examples/future_swarms/universal_swarm_delegation.py) |
...
| **VS Code** | Packaged Extension (Open VSX) | [`cookbook/ides/vscode/`](file:///c:/Users/User/.gemini/antigravity/scratch/autonomous-circularity-network/cookbook/ides/vscode/) | `code --install-extension Bartholomew.bartholomew-guard-vscode` |
