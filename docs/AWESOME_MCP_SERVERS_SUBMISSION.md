...
```markdown
- [btp-guard](https://github.com/bartholomew-ai/bartholomew) - Sub-35µs in-process security proxy for MCP servers in Claude Desktop and Cursor. Intercepts destructive commands (`rm -rf`, `DROP TABLE`) and scrubs API keys in-flight with zero configuration.
```
