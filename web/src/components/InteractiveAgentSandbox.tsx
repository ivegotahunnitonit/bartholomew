...
const PRESETS: SimulationPreset[] = [
  ...
  },
  {
    ...
    accentColor: '#ef4444',
    agent: 'kimi-k1-5-agent (Moonshot AI Kimi Core)',
  ...
  },
  {
    ...
    accentColor: '#06b6d4',
    agent: 'deepseek-r1-swarm (DeepSeek Reasoning Worker)',
