...
// Handles Stripe Direct Payouts (/v1/payouts) to Bartholomew AI Contributors's
// linked bank account (acct_1KCRy9DwLfE70w9S).

import { config } from '../config.ts';

const STRIPE_SECRET_KEY = process.env.STRIPE_SECRET_KEY || config.STRIPE_SECRET_KEY || 'YOUR_STRIPE_SECRET_KEY_HERE';
