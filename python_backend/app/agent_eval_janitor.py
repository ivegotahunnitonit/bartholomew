...
class AgenticQAJanitorEngine:
    ...
    def __init__(self):
        ...
        self.secret_patterns = [
            ...
            (re.compile(r'age_live_[a-zA-Z0-9_\-]{16,}'), "Bartholomew Enterprise Key"),
            (re.compile(r'acn_op_sec_[a-zA-Z0-9_\-]{16,}'), "Operator Security Bearer Key"),
            (re.compile(r'(?i)bearer\s+[a-zA-Z0-9_\-\.\+/=]{12,}'), "Generic Bearer Token"),
            (re.compile(r'(?i)authorization:\s*bearer\s+[a-zA-Z0-9_\-\.\+/=]{12,}'), "Authorization Bearer Header")
        ]
